...
export default function AddERDiagramQuestionPage() {
  ...
  const handleSaveRubric = async () => {
    ...
    try {
      ...
      const saved = await erLabsService.createQuestion(labId, fd);
    ...
    <Container size="xl" py="xl">
      <Stack gap="lg">
        <Group align="baseline" gap="sm">
          ...
          <div>
            <Title order={2}>Add ER Lab Question</Title>
            <Text c="dimmed" mt={6}>
              Create a new ER diagram question inside this lab.
            </Text>
          </div>
        </Group>
