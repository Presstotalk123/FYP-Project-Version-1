    ...
    <Stack gap="sm">
      ...
      <List size="sm" spacing={4}>
        <List.Item>
          ...
          end — it turns with the line&apos;s direction, and its back rests on the entity when
          attached, opening toward the diamond. To attach the line, click it, then drag each
