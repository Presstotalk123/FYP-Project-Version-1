      ...
      <aside className="side">
        {isStaff || isAdmin ? (
          <>
            ...
            <a
              className={isActive('/admin/labs') ? 'active' : ''}
            ...
            <a
              className={isActive('/admin/assessments') ? 'active' : ''}
          ...
          <>
            <a
              className={isActive('/student', true) ? 'active' : ''}
            ...
            <a
              className={isActive('/student/labs') ? 'active' : ''}
            ...
            <a
              className={isActive('/student/assessments') ? 'active' : ''}
